...
```bash
../../scripts/compile.sh parallel_matrix_multiplication.c
```
...
- Compile the program:
  ...
  ```bash
  ../../scripts/compile.sh mpi_init_thread.c
  ```

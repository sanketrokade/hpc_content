...
- Compile the program:
  ...
  ```bash
  ../../scripts/compile.sh mpi_bcast.c
  ```
...
- Compile the program:
  ...
  ```bash
  ../../scripts/compile.sh mpi_bcast1.c
  ```
...
```bash
../../scripts/compile.sh anySource.c
```
...
```bash
../../scripts/compile.sh mpi_status.c
```

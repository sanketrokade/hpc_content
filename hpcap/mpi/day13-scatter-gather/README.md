...
```bash
../../scripts/compile.sh task1_scatter.c
```
...
```bash
../../scripts/compile.sh scatter_sum.c
```
...
- Compile the program:
  ...
  ```bash
  ../../scripts/compile.sh mpi_gather.c
  ```
...
- Compile the program:
  ...
  ```bash
  ../../scripts/compile.sh mpi_array_sum_scatter.c
  ```

...
- Compile the program:
  ...
  ```bash
  ../../scripts/compile.sh mpi_type_struct.c
  ```
...
- Compile the program:
  ...
  ```bash
  ../../scripts/compile.sh mpi_type_struct2.c
  ```
...
- Compile the program:
  ...
  ```bash
  ../../scripts/compile.sh mpi_pack_unpack.c
  ```
...
- Compile the program:
  ...
  ```bash
  ../../scripts/compile.sh mpi_pack_size.c
  ```
...
- Compile the program:
  ...
  ```bash
  ../../scripts/compile.sh mpi_probe_get_count.c
  ```
...
```bash
../../scripts/compile.sh mpi_any_src_and_tag.c
```
...
- Compile the program:
  ...
  ```bash
  ../../scripts/compile.sh mpi_groups_communicators.c
  ```
...
- Compile the program:
  ...
  ```bash
  ../../scripts/compile.sh mpi_task_parallelism_manual_groups.c
  ```
...
- Compile the program:
  ...
  ```bash
  ../../scripts/compile.sh mpi_task_parallelism.c
  ```

...
```bash
../../scripts/compile.sh p2p_mpi_array.c
```
...
- Compile the program:
  ...
  ```bash
  ../../scripts/compile.sh mpi_async.c
  ```
...
- Compile the program:
  ...
  ```bash
  ../../scripts/compile.sh mpi_array_sum.c
  ```

...
- Compile the program:
  ...
  ```bash
  ../../scripts/compile.sh mpi_alltoall_example.c
  ```
...
- Compile the program:
  ...
  ```bash
  ../../scripts/compile.sh mpi_sendrecv_example.c
  ```
...
- Compile the program:
  ...
  ```bash
  ../../scripts/compile.sh mpi_sendrecv_example2.c
  ```
...
- Compile the program:
  ...
  ```bash
  ../../scripts/compile.sh mpi_sendrecv_replace_example.c
  ```
...
- Compile the program:
  ...
  ```bash
  ../../scripts/compile.sh mpi_bsend_example.c
  ```
...
- Compile the program:
  ...
  ```bash
  ../../scripts/compile.sh mpi_bsend_array_example.c
  ```

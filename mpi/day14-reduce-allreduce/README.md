...
```bash
../../scripts/compile.sh arrSum_reduce.c
```
...
```bash
../../scripts/compile.sh arrSum_reduce1.c
```
...
```bash
../../scripts/compile.sh arrSum_allreduce.c
```
...
- Compile the program:
  ...
  ```bash
  ../../scripts/compile.sh mpi_array_sum_timed.c
  ```

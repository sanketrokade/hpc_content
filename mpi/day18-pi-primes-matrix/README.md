...
- Compile the program
  ...
  ```bash
  ../../scripts/compile.sh pi_parallel.c
  ```
...
- Compile the program:
  ...
  ```bash
  ../../scripts/compile.sh prime_count_parallel.c
  ```
...
```bash
#../../scripts/compile.sh serial_mat_add.c
...
```bash
../../scripts/compile.sh serial_mat_add_static.c
```
...
```bash
../../scripts/compile.sh parallel_matrix_add.c
```
...
- Compile
  ...
  ```bash
  ../../scripts/compile.sh mpi_matrix_addition1.c
  ```
...
```bash
../../scripts/compile.sh serial_matrix_multiplication.c
```

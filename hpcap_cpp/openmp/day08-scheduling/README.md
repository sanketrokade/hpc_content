...
```bash
g++ matrixAddition.cpp -fopenmp -o matrixAddition.out
```
...
```bash
g++ static.cpp -fopenmp -o static.out
```
...
```bash
g++ dynamic.cpp -fopenmp -o dynamic.out
```
...
```bash
g++ dynamic2.cpp -fopenmp -o dynamic2.out
```
...
```bash
g++ guided.cpp -fopenmp -o guided.out
```
...
```bash
g++ guided2.cpp -fopenmp -o guided2.out
```
...
```bash
g++ runtime.cpp -fopenmp -o runtime.out
```
...
```bash
g++ sched.cpp -fopenmp -o sched.out
```

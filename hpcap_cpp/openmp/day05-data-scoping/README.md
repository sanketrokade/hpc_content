# Day 5 — OpenMP: Data Scoping Clauses

[← Day 4 — OpenMP: Introduction](../../openmp/day04-openmp-intro/) · [Index](../../README.md) · [Day 6 — OpenMP: Reduction & Timing](../../openmp/day06-reduction-timing/)
...
```bash
g++ task1_sol.cpp -fopenmp -o task1_sol.out
```

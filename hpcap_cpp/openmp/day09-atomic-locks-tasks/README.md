...
```bash
g++ atomic.cpp -fopenmp -o atomic.out
```
...
```bash
g++ nested.cpp -o nested.out -fopenmp
```
...
```bash
g++ section.cpp -fopenmp -o section.out
```
...
```bash
g++ taskParallelism.cpp -fopenmp -o taskParallelism.out
```
...
```bash
g++ taskParallelism1.cpp -fopenmp -o taskParallelism1.out
```
...
```bash
g++ locks.cpp -o locks.out -fopenmp
```

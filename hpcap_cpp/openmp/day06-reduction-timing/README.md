# Day 6 — OpenMP: Reduction & Timing

[← Day 5 — OpenMP: Data Scoping Clauses](../../openmp/day05-data-scoping/) · [Index](../../README.md) · [Day 7 — OpenMP: Synchronization (critical, single, master, barrier)](../../openmp/day07-synchronization/)
...
```bash
g++ manualReduction.cpp -fopenmp -o manualReduction.out
```
...
```bash
g++ manualReduction1.cpp -fopenmp -o manualReduction1.out
```
...
```bash
g++ reduction.cpp -fopenmp -o reduction.out
```
...
```bash
g++ measuringTime.cpp -fopenmp -o measuringTime.out
```
...
```bash
g++ arrayAddition.cpp -fopenmp -o arrayAddition.out
```
...
```bash
g++ errorChecking.cpp -fopenmp -o errorChecking.out
```

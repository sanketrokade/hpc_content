...
```bash
file=demo1
g++ $file.cpp -O2 -o $file.out
#g++ -E $file.cpp > "$file_generated".ii
```

```bash
file=demo1
#g++ $file.cpp -O2 -fdump-tree-all -o $file.out
g++ $file.cpp -O2 -fdump-tree-optimized
